...
import { QrCode, Gift, TrendingUp, History, UserCircle, Store, Heart, Sparkles, Link2, ExternalLink, Globe, CalendarClock, Smartphone, Pencil, Settings, RotateCcw, Download, MapPin, UserPlus, Unlink, Clock, Star, Shield, Bell, Search, Calendar, Camera, Bookmark, Zap, Dices, ShoppingCart, Coffee, Wallet, Rocket } from "lucide-react";
