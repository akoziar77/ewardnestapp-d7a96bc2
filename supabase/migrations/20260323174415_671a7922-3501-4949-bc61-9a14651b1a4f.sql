...
DECLARE
  ...
  _idempotency text;
BEGIN
  -- Look up earn rate from brand_settings via merchant; default to 1 point per dollar
  ...
  -- Calculate points: floor(amount * earn_rate)
  ...
  -- Idempotency key based on transaction id
